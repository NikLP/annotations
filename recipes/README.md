...
Drupal recipes for the Annotations suite. Each recipe is self-contained and can be applied with `drush recipe <path>`, where path is relative to the drupal directory.
