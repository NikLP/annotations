...
use Drupal\annotations_audit\CoverageService;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Symfony\Component\HttpFoundation\Request;

/**
 * Renders the annotation audit coverage report page.
 */
class CoverageController extends ControllerBase {
  ...
  public static function create(ContainerInterface $container): static {
    return new static(
      $container->get('annotations_audit.coverage_service'),
  ...
  public function page(Request $request): array {
    ...
    $filter_form = $this->formBuilder()->getForm(
      'Drupal\annotations_audit\Form\CoverageFilterForm',
      $entity_types,
      $filter_type,
      $filter_status,
    );
      ...
      if ($can_annotate) {
        $ops['annotate'] = [
          ...
          'url'   => Url::fromRoute('annotations_ui.target.collection', ['annotation_target' => $id], [
            'query' => ['destination' => Url::fromRoute('annotations_audit.coverage')->toString()],
          ]),
        ];
      }
    ...
    return [
      '#attached' => ['library' => ['annotations_audit/annotations_audit.coverage']],
      '#cache' => [
