 ...
 * annotations_audit 3rd-party setting on AnnotationType (affects_coverage).
 ...
 * annotations_audit.coverage_service and call getCoverage() or
...
class CoverageService {
   ...
   *
   * Reads the annotations_audit third-party setting.
   */
  public function affectsCoverage(AnnotationTypeInterface $type): bool {
    return (bool) $type->getThirdPartySetting('annotations_audit', 'affects_coverage', FALSE);
  }
